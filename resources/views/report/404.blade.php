                ...
                <div class="bg-gray-100 dark:bg-gray-900 p-8 rounded-lg shadow-lg transform hover:scale-105 transition duration-300 max-w-lg w-full">
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <p class="text-center p-4">
                            <a href="/dashboard/index" class="inline-block px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-300">
                                Go back to Home
                            </a>
                        </p>
                    </div>
