<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mb-4  space-y-6">
            <div x-data="{ showFilter: false }" class="p-6 bg-white dark:bg-gray-800 shadow rounded-lg">
                ...
                <div class='flex items-right justify-end space-x-4'>
                    ...
                    <button @click="showFilter = !showFilter"
                            ...
                            class="px-4 py-2 bg-blue-600 text-white rounded-md shadow hover:bg-blue-700 transition duration-150 ease-in-out mb-4">
                    </button>
                </div>
